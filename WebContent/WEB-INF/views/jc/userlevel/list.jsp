			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
                            ...
                            &nbsp;&nbsp;<span id="userLevelId"><label></label>：<select  data-placeholder="状态" name="level" class="chosen-select isSelect105"></select></span>
                            &nbsp;&nbsp;<span id="upgradeTypeId"><label></label>：<select  data-placeholder="状态" name="upgradeType" class="chosen-select isSelect75"></select></span>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:8%" class="center">比赛类别</th>
                                <th style="width:8%" class="center">用户等级</th>
                                <th style="width:5%"  class="center">升级<br/>方式</th>
                                <th style="width:5%"  class="center">竞猜<br/>场次</th>
                                <th style="width:5%"  class="center">胜/负<br/>场次</th>
                                <th style="width:5%"  class="center">盈利率</th>
                                <th style="width:5%"  class="center">创建时间</th>
                                <th style="width:5%"  class="center">更新时间</th>
                                <th style="width:5%"  class="center">排序</th>
<%--
                                <th style="width:5%"  class="center">是否<br/>有效</th>
--%>
...
<script src="${jypath}/static/js/jc/userlevel/userlevel.js"></script>
</html>