			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							...
							<select class="chosen-select isSelect75" name="state">
...
--%>
                                ...
                                <th style="width:8%"  class="center">推理标题</th>
                                <th style="width:8%"  class="center">推理理由</th>
                                <th style="width:8%"  class="center">比赛类型</th>
                                <th style="width:8%"  class="center">盈利率</th>
                                <%--<th style="width:8%"  class="center">状态</th>
                                <th style="width:8%"  class="center">开奖状态</th>--%>
...
<script src="${jypath}/static/js/jc/recommendbill/recommendbill.js"></script>
</html>