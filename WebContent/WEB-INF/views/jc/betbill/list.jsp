			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
                            ...
                            &nbsp;&nbsp;<span id="matchTypeId"><label></label>：<select  data-placeholder="比赛类型" name="matchType" class="chosen-select isSelect75"></select></span>
                            &nbsp;&nbsp;
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:8%"  class="center">投注金额</th>
                                <th style="width:8%"  class="center">投注笔数</th>
                                <th style="width:8%"  class="center">预计奖金</th>
                                <th style="width:8%"  class="center">实际奖金</th>
                                <th style="width:8%"  class="center">几串几</th>
                                <th style="width:8%"  class="center">比赛类型</th>
<%--
                                <th style="width:8%"  class="center">状态</th>
--%>
                                <th style="width:8%"  class="center">是否中奖</th>
...
<script src="${jypath}/static/js/jc/betbill/betbill.js"></script>
</html>