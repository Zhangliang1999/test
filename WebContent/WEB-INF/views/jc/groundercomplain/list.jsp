					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:10%" class="center">投诉编码</th>
                                <th style="width:10%" class="center">滚球单编码</th>
                                <th style="width:10%" class="center">被投诉人</th>
                                <th style="width:10%" class="center">投诉人</th>
                                <th style="width:10%" class="center">是否处理</th>
                                <th style="width:8%"  class="center">回复记录</th>
...
<script src="${jypath}/static/js/jc/groundercomplain/groundercomplain.js"></script>
</html>