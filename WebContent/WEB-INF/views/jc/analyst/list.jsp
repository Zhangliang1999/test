			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">
							...
							&nbsp;&nbsp;<span id="selectisValid"><label>状态</label>：<select  data-placeholder="状态" name="state" class="isSelect145">
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:8%"  class="center">身份证</th>
                                <th style="width:8%"  class="center">从业经验</th>
...
<script src="${jypath}/static/js/jc/analyst/analyst.js"></script>
</body>
</html>