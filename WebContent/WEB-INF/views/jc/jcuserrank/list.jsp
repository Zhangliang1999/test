			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
                            ...
                            &nbsp;&nbsp;
                            <span><label>类型</label>：
                            <select  data-placeholder="类型" name="type" class="chosen-select isSelect75">
                                <option value="" selected>全部</option>
                                <option value="1">周榜</option>
                                <option value="2">月榜</option>
                            </select></span>                            &nbsp;&nbsp;
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:8%"  class="center">盈利率</th>
                                <th style="width:8%"  class="center">胜场次</th>
                                <th style="width:8%"  class="center">负场次</th>
                                <th style="width:8%"  class="center">星级</th>
                                <th style="width:8%"  class="center">粉丝数</th>
<%--
...
<script src="${jypath}/static/js/jc/jcuserrank/jcuserrank.js"></script>
</html>