					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:10%" class="center">个人强项</th>
                                <th style="width:8%"  class="center">总盈利率</th>
                                <th style="width:8%"  class="center">总胜</th>
                                <th style="width:8%"  class="center">总胜</th>
                                <th style="width:8%"  class="center">我的购买</th>
                                <th style="width:8%"  class="center">我的竞猜</th>
                                <th style="width:8%"  class="center">最高等级</th>
                                <th style="width:8%"  class="center">总消费</th>
                                <th style="width:8%"  class="center">总充值</th>
                                <th style="width:8%"  class="center">总兑换</th>
...
<script src="${jypath}/static/js/jc/jcuserstatis/jcuserstatis.js"></script>
</html>