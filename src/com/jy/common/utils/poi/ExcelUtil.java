...
public final class ExcelUtil {
	...
	/** Excel 文件要存放的位置 */
	public static String outputFile = "D:/Users/susen/Desktop/系统/输出测试.xls";
...
//	}
	 ...
	 */
	public static void bulidExcel(String excel_name, String[] headList,
			List<List<String>> valueList) throws Exception {
		// 创建新的Excel 工作簿
		HSSFWorkbook workbook = new HSSFWorkbook();
		...
		for (int n = 0; n < valueList.size(); n++) {
			// 在索引1的位置创建行（最顶端的行）
			HSSFRow row_value = sheet.createRow(n + 1);
			List<String> valueArray = valueList.get(n);
			// ===============================================================
			for (int i = 0; i < valueArray.size(); i++) {
				...
				cell.setCellType(HSSFCell.CELL_TYPE_STRING);
				// 在单元格中输入一些内容
				cell.setCellValue(valueArray.get(i));
			}
			// ===============================================================
		}
     ...
     * @throws Exception
     */
    public static List<String[]> readExcel(FileInputStream fis) throws Exception {
// 结果集
        List<String[]> list = new ArrayList<String[]>();
