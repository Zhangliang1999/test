						...
						<li class="userperLi">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img id="mainHeadpic" class="nav-user-photo" src="<c:choose>
										<c:when test="${!empty currentAccount.picUrl}">${jypath}${currentAccount.picUrl}</c:when>
										<c:otherwise><c:url value="${jypath}/static/images/system/user/hpic0.jpg" /></c:otherwise>
										</c:choose>" />
