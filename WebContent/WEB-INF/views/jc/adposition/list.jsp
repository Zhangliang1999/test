			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							...
							&nbsp;&nbsp;<span id="adPositionTypeId"><label></label>：<select  data-placeholder="状态" name="adPositionType" class="chosen-select isSelect145"></select></span>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">APP广告位类型</th>
                                <th style="width:8%"  class="center">地址</th>
                                <th style="width:8%"  class="center">链接</th>
                                <th style="width:8%"  class="center">顺序</th>
...
<script src="${jypath}/static/js/jc/adposition/adposition.js"></script>
</html>