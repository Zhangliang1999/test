					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:10%" class="center">问题描述</th>
                                <th style="width:8%"  class="center">提问时间</th>
                                <th style="width:8%"  class="center">回复人</th>
                                <th style="width:8%"  class="center">回复内容</th>
                                <th style="width:8%"  class="center">回复时间</th>
...
<script src="${jypath}/static/js/jc/questionfeedback/questionfeedback.js"></script>
</html>