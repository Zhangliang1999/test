			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
                            ...
                            &nbsp;&nbsp;<span id="accountSourceId"><label></label>：<select  data-placeholder="状态" name="source" class="chosen-select isSelect135"></select></span>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
                                ...
                                <th style="width:10%" class="center">上一次余额</th>
                                <th style="width:10%" class="center">当前余额</th>
                                <th style="width:10%" class="center">收入</th>
                                <th style="width:10%" class="center">支出</th>
                                <th style="width:10%" class="center">来源</th>
...
<script src="${jypath}/static/js/jc/jcaccountlog/jcaccountlog.js"></script>
</html>